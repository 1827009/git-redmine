...
upurl="http://localhost:3000/uploads.json"
myheaders = {
...
payload = {
    ...
    "issue": {
        ...
        "uploads": [
            {
                "token": "13.1aba09fc693e46b70462b5ceb5eae57637c5b2cac2f895310910c392f50e29df",
                "filename": "image.png",
...
r=requests.put(url,headers=myheaders,data=json.dumps(payload))
# Response=urlopen(r)
# ret=Response.read()
# print(ret)
